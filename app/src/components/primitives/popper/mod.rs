use floating_ui_leptos::{
    ...
    Size, SizeOptions, Strategy, UseFloatingOptions, UseFloatingReturn, ARROW_NAME, HIDE_NAME,
};
...
use super::arrow::Arrow as ArrowPrimitive;
use leptos_node_ref::AnyNodeRef;
// use radix_leptos_compose_refs::use_composed_refs;
use super::common::size::use_size;
...
pub fn Popper(
    children: ChildrenFn,
    #[prop(optional, into)] anchor_ref: Option<AnyNodeRef>,
) -> impl IntoView {
    let anchor_ref = if let Some(_ref) = anchor_ref {
        _ref
    } else {
        AnyNodeRef::new()
    };
...
pub fn PopperContent(
    #[prop( optional, default = Side::Bottom.into())] side: Signal<Side>,
    #[prop( optional, default = 0.0.into())] side_offset: Signal<f64>,
    #[prop( optional, default = Align::Center.into())] align: Signal<Align>,
    #[prop( optional, default = 0.0.into())] align_offset: Signal<f64>,
    #[prop( optional, default = 0.0.into())] arrow_padding: Signal<f64>,
    #[prop( optional, default = true.into())] avoid_collisions: Signal<bool>,
    #[prop( optional, default = SendWrapper::new(vec![]).into())] collision_boundary: Signal<
        SendWrapper<Vec<web_sys::Element>>,
    >,
    #[prop( optional, default = Padding::All(0.0).into())] collision_padding: Signal<Padding>,
    #[prop( optional, default = Sticky::Partial.into())] sticky: Signal<Sticky>,
    #[prop( optional, default = false.into())] hide_when_detached: Signal<bool>,
    #[prop( optional, default = UpdatePositionStrategy::Optimized.into())]
    ...
    // #[prop(optional)] open: MaybeProp<bool>,
    children: ChildrenFn,
) -> impl IntoView {
