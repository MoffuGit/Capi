        ...
        <TabPrimitive
            ...
            class=MaybeProp::derive(move || {
                Some(tw_merge!(
                    ...
                    "text-sm font-medium whitespace-nowrap transition-[color,box-shadow] ease-in-out focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
                    class.get()
                ))
            })
            {..}
